        ...
        <div id="main">
            ...
            <div id="middle">
                <div id="left-column">
                    ...
                    <ul class="nav">
                        <li>
                            <a href="../inde.phpx" target="_blank">Home</a>
                        </li>
                        <li>
                ...
                <div id="center-column">
                    ...
                    <form name="frmMain" action="#" method="POST">
                        ...
                        <div class="table">
                            <table id='example' class='display' cellspacing='0' border='1'>
                                <thead>
                                    <tr>
                                        <td colspan="6">
                                            <strong><div align="center"><h3>Word in mysql</h3></strong></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th><div align="center">ID</div></th>
                                        <th><div align="center">Beford Word</div></th>
                                        <th><div align="center">After Word</div></th>
                                        <th><div align="center">POS</div></th>
                                        <th><div align="center">Count word</div></th>
                                        <th><div align="center">
                                                Delete  <input name="CheckAll" type="checkbox" id="CheckAll" value="Y" onClick="ClickCheckAll(this);">
                                            </div></th>
                                    </tr>
                                </thead>
                                <?php
                        ...
                        for ($i = 0; $i < count($_POST["chkDel"]); $i++) {
                            if ($_POST["chkDel"][$i] != "") {
                                $sql = "DELETE FROM logs WHERE id = '" . $_POST["chkDel"][$i] . "' ";
                                $result = mysqli_query($link, $sql) or die(mysqli_error($link));
                            }
                        }
                        ?>
